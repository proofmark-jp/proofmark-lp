...
export default function TakedownNoticeModal({
  ...
  defaultLanguage = 'ja',
  onComplete,
}: TakedownNoticeModalProps): React.JSX.Element | null {
...
function GeneratingBody({
  progress,
  reduce,
}: GeneratingBodyProps): React.JSX.Element {
  return (
    <>
...
function SuccessBody({
  ...
  onClose,
  reduce,
}: SuccessBodyProps): React.JSX.Element {
  return (
    <motion.div
      animate={
        reduce
...
function ErrorBody({ message, onRetry }: ErrorBodyProps): React.JSX.Element {
  return (
    <>
    ...
    >
      <Page size="A4" style={pdfStyles.page}>
        ...
        <View style={pdfStyles.headerContainer} fixed>
          <View>
            <View style={{ width: 140, height: 28, marginBottom: 4 }}>
              <Svg viewBox="0 0 470 96" width="100%" height="100%">
                ...
                {/* メインシンボル（PDFKitのバグを防ぐため、線はグラデーションではなく単色指定） */}
                ...
                {/* PROOFMARK ワードマーク（ベクターパス化・フォーマルな濃紺） */}
                <G fill="#1A233A">
                  <Path d="M139.476 56.730000000000004V50.08H158.438Q159.578 50.08 160.357 49.719Q161.136 49.358000000000004 161.136 48.18Q161.136 46.964 160.357 46.622Q159.578 46.28 158.438 46.28H140.084V63.0H130.584V38.68H156.956Q159.806 38.68 162.29500000000002 39.079Q164.784 39.478 166.646 40.504000000000005Q168.50799999999998 41.53 169.572 43.392Q170.636 45.254000000000005 170.636 48.18Q170.636 51.106 169.572 52.816Q168.50799999999998 54.525999999999996 166.646 55.361999999999995Q164.784 56.198 162.29500000000002 56.464Q159.806 56.730000000000004 156.956 56.730000000000004Z M174.436 44.379999999999995H183.556V63.0H174.436ZM193.36 51.41Q190.89 51.41 188.838 51.866Q186.786 52.322 185.34199999999998 52.949Q183.898 53.576 183.176 54.184L183.1 52.36Q183.214 51.562 183.708 50.479Q184.202 49.396 185.038 48.237Q185.874 47.078 187.09 46.071Q188.306 45.064 189.883 44.437Q191.46 43.81 193.36 43.81Z M213.5 63.57Q207.458 63.57 203.449 62.582Q199.44 61.594 197.445 59.428Q195.45000000000002 57.262 195.45000000000002 53.728Q195.45000000000002 50.194 197.445 48.009Q199.44 45.824 203.449 44.817Q207.458 43.81 213.5 43.81Q219.50400000000002 43.81 223.47500000000002 44.817Q227.446 45.824 229.422 48.009Q231.398 50.194 231.398 53.728Q231.398 57.262 229.422 59.428Q227.446 61.594 223.47500000000002 62.582Q219.50400000000002 63.57 213.5 63.57ZM213.5 58.06Q216.312 58.06 218.212 57.585Q220.112 57.11 221.1 56.141Q222.088 55.172 222.088 53.728Q222.088 52.284 221.119 51.296Q220.15 50.308 218.25 49.814Q216.35 49.32 213.5 49.32Q210.688 49.32 208.731 49.814Q206.774 50.308 205.767 51.277Q204.76 52.246 204.76 53.728Q204.76 55.172 205.748 56.141Q206.736 57.11 208.69299999999998 57.585Q210.65 58.06 213.5 58.06Z M252.108 63.57Q246.066 63.57 242.05700000000002 62.582Q238.048 61.594 236.053 59.428Q234.05800000000002 57.262 234.05800000000002 53.728Q234.05800000000002 50.194 236.053 48.009Q238.048 45.824 242.05700000000002 44.817Q246.066 43.81 252.108 43.81Q258.112 43.81 262.083 44.817Q266.05400000000003 45.824 268.03000000000003 48.009Q270.00600000000003 50.194 270.00600000000003