        ...
        <div className="mt-20 max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-xl border border-[#1C1A38] bg-[#0D0B24]/70 p-5">
              ...
              <p className="text-sm text-[#A8A0D8] leading-relaxed">
                ProofMarkは単なる「節約ツール」ではなく、プロフェッショナルのための「信頼担保インフラ」だからです。重要な証拠基盤を安売りすることは、逆に「実務で使って大丈夫か」という取引先の不信を招きます。本プランは、クライアントへそのまま提出できる『PDF証明書・証拠一式（月30件）』、NDA対応の非公開モード、案件管理機能など、プロが「信用を丸ごと納品する」ための完全な環境を提供します。ツールではなく、あなたの作品を守る「信頼の証」としての価値を価格に反映しています。
              </p>
            </div>
            <div className="rounded-xl border border-[#1C1A38] bg-[#0D0B24]/70 p-5">
              <p className="font-bold text-white text-sm mb-1.5">
